...
Console.WriteLine($"{c + a}"); // without casting
Console.WriteLine($"{(char)(c + a)}"); // with casting
Console.WriteLine($"{f + a}"); // without casting
Console.WriteLine($"{f + c}"); // without casting


// Instance of a struct (which is a value type)
s s1;
s1.a = 5;
s1.b = false;
